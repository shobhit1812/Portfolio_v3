      ...
      <div className="Container">
        ...
        <div className="BigCard">
          ...
          <div className="AboutBio">
            Hello! My name is <strong>Shobhit Nautiyal</strong> I am 22 years old , I was Born in Rudraprayag , 18 Dec 2000 and My personality Easy going person and easy to find a new friend. I Am Very Interested In The Creative Field , Being A Developer Is One Of My Life Goals, With A Talent In This Field I Want To Always Learn New Things And Strengthen Every Process.
          </div>
          <div className="AboutBio tagline2">
          And I am a student of Institute of Technology, Gopeshwar. I learn on Web Development , and DSA.
          </div>
          <Technologies>
